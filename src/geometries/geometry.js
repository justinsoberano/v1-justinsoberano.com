...
// loader.load('/justinsoberano.com/src/renderer/fonts/helvetiker_regular.typeface.json', function(font) {
//     const textGeometry = new TextGeometry('Hel!', {
//         font: font,
//         size: 6,
//         height: 2,
//     });
//     const textMaterial = new THREE.MeshBasicMaterial( { color: 0x00ff00 } );
//     const text = new THREE.Mesh(textGeometry, [new THREE.MeshBasicMaterial({color: 0x000000}), textMaterial]);
//     scene.add(text);
// });
